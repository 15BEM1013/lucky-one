...
def process_symbol(symbol, alert_queue):
    try:
        ...
        if detect_rising_three(candles):
            ...
            price_above_ema21 = first_small_candle_close > emaенин21
            ema9_aboveಸabove_ema21 = ema9 > ema21
            ema_status = {
